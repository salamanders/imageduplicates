...
/**
 * pHash-like image hash. Author: Elliot Shepherd elliot@jarofworms.com Based
 * On:
...
public class ImagePHash {
  ...
  public byte[] getHash(final BufferedImage img1) throws Exception {
     ...
     */
    final BufferedImage img = Scalr.resize(img1, Scalr.Method.AUTOMATIC, Scalr.Mode.FIT_EXACT, SIZE,
        Scalr.OP_GRAYSCALE);
     ...
     * value (using only the 8x8 DCT low-frequency values and excluding the
     * first term since the DC coefficient can be significantly different from
